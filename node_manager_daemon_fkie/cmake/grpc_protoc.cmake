...
macro(generate_grpc)
    ...
    set(GRPC_GENERATED_SRC_DIR "${CATKIN_DEVEL_PREFIX}/${CATKIN_PACKAGE_PYTHON_DESTINATION}/generated")
    # set(GRPC_GENERATED_SRC_DIR "${PROJECT_SOURCE_DIR}/src/${PROJECT_NAME}/generated")
    ...
    foreach(PROTO_FILE ${PROTO_FILES})
        ...
        list(APPEND GEN_PROTO_FILES ${GRPC_GENERATED_SRC_DIR}/${PROTO_FILE}_pb2_grpc.py)
        message(STATUS "generate gRPC code from ${ABS_PROTO_FILE}")
        add_custom_command(
            OUTPUT ${GRPC_GENERATED_SRC_DIR}/${PROTO_FILE}_pb2_grpc.py ${GRPC_GENERATED_SRC_DIR}/${PROTO_FILE}_pb2.py
            COMMAND "${PYTHON}" -m grpc_tools.protoc -I${ABS_PROTO_PATH} --python_out=${GRPC_GENERATED_SRC_DIR}/. --grpc_python_out=${GRPC_GENERATED_SRC_DIR}/. ${ABS_PROTO_FILE}
