# -*- coding: utf-8 -*-
#
# fkie_master_discovery documentation build configuration file, created by
...
project = u'fkie_master_discovery'
...
htmlhelp_basename = 'fkie_master_discoverydoc'
...
latex_documents = [
  ('index', 'fkie_master_discovery.tex', u'master\\_discovery\\_fkie Documentation',
...
man_pages = [
    ('index', 'fkie_master_discovery', u'fkie_master_discovery Documentation',
